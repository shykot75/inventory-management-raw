                                        ...
                                        <div class="flex justify-center">
                                            <div class="dropdown relative">
                                                <button type="button"
                                                        ...
                                                        id="dropdownMenuheading-<?php echo $item['purchase_return_id']; ?>" onclick="toggleDropdown(<?php echo $item['purchase_return_id']; ?>)">
                                                    <i class="fas fa-ellipsis-v"></i>
                                                </button>
                                                <ul id="dropdownMenu-<?php echo $item['purchase_return_id']; ?>" class="absolute z-50 py-2 mt-1 list-none bg-white rounded-md shadow-md dropdown-toggle-menu min-w-max hidden">
                                                    <li>
