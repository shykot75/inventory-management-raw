                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <?php if ($purchase['is_returned'] == 1): ?>
                                                <!-- If the purchase is already returned, disable the return button -->
                                            ...
                                            <?php else: ?>
                                                <!-- If the purchase is not returned, show the return button -->
                                                <a href="purchase-return.php?purchase_id=<?php echo $purchase['purchase_id']; ?>" class="block px-4 py-1.5 text-base font-medium text-slate-600">
                                                    <i class="fa-solid fa-pen-to-square mr-1"></i> Return
                                                </a>
                                            <?php endif; ?>

<!--                                            <a href="purchase-pdf.php?purchase_id=--><?php //echo $purchase['purchase_id']; ?><!--" class="block px-4 py-1.5 text-base font-medium text-slate-600">-->
